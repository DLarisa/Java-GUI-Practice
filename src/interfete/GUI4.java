...
public class GUI4 extends JFrame implements ActionListener {
    ...
    GUI4() {
        ...
        button.addActionListener(new GUI4.ButtonListener());
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select nume from dragoni");
    ...
    public void showData() {
        ...
        f1.setTitle("Show Dragoni");


        l5 = new JLabel("Displaying Dragoni:");       
        ...
        l2 = new JLabel("Specie:");

        l3 = new JLabel("Element:");
       ...
       try {    
           ...
           Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","root","root");  
           PreparedStatement ps = con.prepareStatement("select * from dragoni where nume=?");
