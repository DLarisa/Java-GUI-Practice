...
/**
    ...
    GUI1() {  
        //Providing Title  
        super("Fetching Dragon Information");  
        ...
        lb = new JLabel("Fetching Dragon Information From Database");  
        ...
        btn1.addActionListener(new GUI1.ButtonListener());
    ...
    public void actionPerformed(ActionEvent e) {  
        ...
        try {  
            ...
            PreparedStatement st = con.prepareStatement("select * from dragoni where nume=?");  
            st.setString(1, str);  
            //Excuting Query  
            ResultSet rs = st.executeQuery();  
            if (rs.next()) {  
                String s = rs.getString("nume");  
                String s1 = rs.getString("specie");  
                String s2 = rs.getString("element");  
